        ...
        <div className='flex h-screen items-center justify-center'>
            <div className="card w-96 bg-base-100 shadow-xl">
                <div className="card-body bg-pink-200">
                    ...
                    <p><small>Forgot Password?</small><Link className='text-primary' onClick={resetPassword} to="/login">Reset Password</Link></p>

                    <p><small>New to Doctors Portal? </small><Link className='text-primary' to="/register"> Create New Account</Link></p>
